...
objects (beans) using sensible defaults ("opinions"). If something is no on classpath, cannot be added and configured.
...
It is recommended to use starter pom packages, like:
